...
def main():
    ...
    while func < len(functions):
        ...
        print("curr function is " + onefunc.get("name"))
...
def basicblocks(onefunc): #copy pasted from last week (with print statements i'd had to display the answer removed)
    blocks = []
    labelstoblock = {}
    currlabel = [False, ""]
